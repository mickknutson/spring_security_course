...
public class WelcomeControllerTests {
    ...
    public void testHomePage() throws Exception {
        ...
        assertThat(content).contains("Chapter 05.00");
        assertThat(content).contains("Base line Starting from chapter04.04");
    ...
    public void testHomePage_htmlUnit() throws Exception {
        ...
        assertThat(chapterHeading).contains("Chapter 05.00");
        ...
        assertThat(summary).contains("Base line Starting from chapter04.04");
    }
