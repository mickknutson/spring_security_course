...
public class WelcomeControllerTests {
    ...
    public void testHomePage() throws Exception {
        ...
        assertThat(content).contains("Chapter 06.00");
        assertThat(content).contains("Remember-Me Services");
    ...
    public void testHomePage_htmlUnit() throws Exception {
        ...
        assertThat(chapterHeading).contains("Chapter 06.00");
        ...
        assertThat(summary).contains("Remember-Me Services");
    }
