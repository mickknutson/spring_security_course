...
public class WelcomeControllerTests {
    ...
    public void testHomePage() throws Exception {
        ...
        assertThat(content).contains("Chapter 04.04");
        assertThat(content).contains("Configuring secure passwords");
    ...
    public void testHomePage_htmlUnit() throws Exception {
        ...
        assertThat(chapterHeading).contains("Chapter 04.04");
        ...
        assertThat(summary).contains("Configuring secure passwords");
    }
