...
public class WelcomeControllerTests {
    ...
    public void testHomePage() throws Exception {
        ...
        assertThat(content).contains("Chapter 04.00");
        assertThat(content).contains("JDBC-Based Authentication");
    ...
    public void testHomePage_htmlUnit() throws Exception {
        ...
        assertThat(chapterHeading).contains("Chapter 04.00");
        ...
        assertThat(summary).contains("JDBC-Based Authentication");
    }
