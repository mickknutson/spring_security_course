 ...
 * @since chapter09.05 updated @RolesAllowed("hasRole('ADMIN')") to findAllEvents()
 * @since chapter09.06 added @PreAuthorize("hasRole('ADMIN') to findEventByUser()
 * @since chapter09.07 added @PostAuthorize to findEventById
 *
 */
public interface EventService {
     ...
     */
    @PostAuthorize("hasRole('ADMIN') or authentication.principal.id == returnObject.owner.id or authentication.principal.id == returnObject.attendee.id")
