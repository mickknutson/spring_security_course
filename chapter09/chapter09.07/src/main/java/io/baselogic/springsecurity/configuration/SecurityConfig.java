 ...
 * @since chapter09.04 Added @EnableGlobalMethodSecurity(prePostEnabled = true)
 * @since chapter09.05 updated @EnableGlobalMethodSecurity(jsr250Enabled = true)
 * @since chapter09.06 updated @EnableGlobalMethodSecurity(prePostEnabled = true)
 */
@Configuration
@EnableWebSecurity
