...
import io.baselogic.springsecurity.annotations.WithMockEventUserDetailsUser2;
...
class AdvancedAuthorizationTests {
    ...
    @WithMockEventUserDetailsUser1
    void test_login_user1__no_h2Link() throws Exception {
        MvcResult result = mockMvc.perform(get("/"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    @Test
    @DisplayName("Login as user1 -  Access admin secured event listing")
    @WithMockEventUserDetailsUser1
    void test_login_user1_access_admin_event_listing() throws Exception {
    ...
    @Test
    @DisplayName("Login as user1 -  Access my events")
    @WithMockEventUserDetailsUser1
    public void login_user1_access_my_events() throws Exception {
        MvcResult result = mockMvc.perform(get("/events/my"))
                .andExpect(status().isOk())
                .andReturn();
        ...
        assertThat(content).contains("Current User Events");

        assertThat(content).contains("Birthday Party");
        assertThat(content).doesNotContain("Lunch");
    }

    @Test
    @DisplayName("Login as user2 -  Access my events")
    @WithMockEventUserDetailsUser2
    public void login_user2_access_my_events() throws Exception {
        MvcResult result = mockMvc.perform(get("/events/my"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    @WithMockEventUserDetailsAdmin1
    void test_login_admin1__with_h2Link() throws Exception {
        MvcResult result = mockMvc.perform(get("/"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    @WithMockEventUserDetailsAdmin1
    void test_login_admin1_access_admin_event_listing() throws Exception {
        MvcResult result = mockMvc.perform(get("/events/102"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    @Test
    @DisplayName("Login as admin1 -  Access my events")
    @WithMockEventUserDetailsAdmin1
    public void login_admin1_access_my_events() throws Exception {
        MvcResult result = mockMvc.perform(get("/events/my"))
                .andExpect(status().isOk())
                .andReturn();
        ...
        assertThat(content).doesNotContain("Birthday Party");
