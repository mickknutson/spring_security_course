...
public class TraceAspect {
    ...
    @Pointcut(value = "execution(* org.springframework.security.authentication.*.*(..)) ||" +
                      "execution(* org.springframework.security.crypto.password.*.*(..))")
    public void inSecurityLayer() {}



    @Around("inWebLayer() || inServiceLayer() || inDaoLayer() || inUserDetailsLayer() || inSecurityLayer()")
