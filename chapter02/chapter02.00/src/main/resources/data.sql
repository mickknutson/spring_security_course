...
-- User Data
INSERT INTO appUsers(id,email,password,first_name,last_name) VALUES (0,'user1@baselogic.com','user1','User','One');
INSERT INTO appUsers(id,email,password,first_name,last_name) VALUES (1,'admin1@baselogic.com','admin1','Admin','One');
INSERT INTO appUsers(id,email,password,first_name,last_name) VALUES (2,'user2@baselogic.com','user2','User','Two');
