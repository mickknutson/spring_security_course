...
public class WelcomeControllerTests {
    ...
    public void testHomePage() throws Exception {
        ...
        assertThat(content).contains("Chapter 03.02");
        assertThat(content).contains("Logging in new users using SecurityContextHolder");
    ...
    public void testHomePage_htmlUnit() throws Exception {
        ...
        assertThat(chapterHeading).contains("Chapter 03.02");
        ...
        assertThat(summary).contains("Logging in new users using SecurityContextHolder");
    }
