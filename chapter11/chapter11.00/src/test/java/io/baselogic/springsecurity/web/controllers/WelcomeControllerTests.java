...
public class WelcomeControllerTests {
    ...
    public void testHomePage() throws Exception {
        ...
        assertThat(content).contains("Chapter 11.00");
        assertThat(content).contains("Custom Authorization");
    ...
    public void testHomePage_htmlUnit() throws Exception {
        ...
        assertThat(chapterHeading).contains("Chapter 11.00");
        ...
        assertThat(summary).contains("Custom Authorization");
    }
