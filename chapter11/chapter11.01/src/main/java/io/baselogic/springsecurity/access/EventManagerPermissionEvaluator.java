package io.baselogic.springsecurity.access;

import io.baselogic.springsecurity.dataaccess.EventDao;
...
public final class EventPermissionEvaluator implements PermissionEvaluator {
    private final EventDao eventDao;

    public EventPermissionEvaluator(EventDao eventDao) {
    ...
    private String extractEmail(EventUser user) {
        if(user == null) {
            return null;
        }
