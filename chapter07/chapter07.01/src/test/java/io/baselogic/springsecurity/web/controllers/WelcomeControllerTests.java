...
public class WelcomeControllerTests {
    ...
    public void testHomePage() throws Exception {
        ...
        assertThat(content).contains("Chapter 07.01");
        assertThat(content).contains("Advanced Certificate Authentication");
    ...
    public void testHomePage_htmlUnit() throws Exception {
        ...
        assertThat(chapterHeading).contains("Chapter 07.01");
        ...
        assertThat(summary).contains("Advanced Certificate Authentication");
    }
